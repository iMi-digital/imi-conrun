...
/**
 * Create a contao module skeleton
 */
class CreateCommand extends AbstractContaoCommand
{
    /**
     * @var array
     */
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Create and register a new contao module.');
    }
    ...
    protected function createModuleDirectories(InputInterface $input, OutputInterface $output)
    {
        if ($this->modmanMode) {
            ...
            $this->_contaoRootFolder = './' . $modManDir;
            mkdir($this->_contaoRootFolder . '/app/etc/modules', 0777, true);
        }
        $moduleDir = $this->_contaoRootFolder
                   . '/app/code/'
                   . $this->codePool
    ...
    {
        $outFile = $this->_contaoRootFolder
                 . '/app/etc/modules/'
                 . $this->vendorNamespace
                 . '_'
                 . $this->moduleName
    ...
    {
        $outFile = $this->_contaoRootFolder . '/../modman';
        file_put_contents(
            $outFile,
     ...
     *
     * @see https://raw.github.com/sprankhub/Contao-Extension-Sample-Readme/master/readme.markdown
     *
    ...
    protected function writeReadme($input, $output)
    {
        ...
        if ($this->modmanMode) {
            $outFile = $this->_contaoRootFolder . '/../readme.md';
        } else {
    ...
    protected function writeComposerConfig(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($this->modmanMode) {
            $outFile = $this->_contaoRootFolder . '/../composer.json';
        } else {
    ...
    {
        $pathes = array(
            'rootDir'   => $this->_contaoRootFolder,
