...
namespace IMI\Contao\Command\Developer\Code\Model;
...
class MethodCommand extends AbstractContaoCommand
{
    /**
     * @var InputInterface
     */
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $this->_input  = $input;
        $this->_output = $output;
        $this->detectContao($this->_output, true);
        if (false === $this->initContao()) {
            throw new \RuntimeException('Contao could not be loaded');
        }
        $this->checkModel();
    ...
    protected function initTableColumns()
    {
        ...
        /* @var $dbHelper \IMI\Util\Console\Helper\DatabaseHelper */
        /** @var \PDO $connection */
