...
HELP;
    ...
    public function getTableDefinitionHelp()
    {
        ...
        $this->commandConfig = $this->getCommandConfig();
        $messages .= <<<HELP
<comment>Strip and exclude options</comment>
 ...
 The --exclude option uses the same syntax, but here the tables (also the structure)
 will be skipped.
...
HELP;
     ...
     * @param \Symfony\Component\Console\Input\InputInterface $input
     * @param \Symfony\Component\Console\Output\OutputInterface $output
     * @param \IMI\Contao\Command\Database\Compressor\AbstractCompressor $compressor
     * @return string
     */
