...
namespace IMI\Contao\Command\Cms\Banner;
 ...
 *
 * @codeCoverageIgnore
 * @package IMI\Contao\Command\Cms\Banner
 */
class ToggleCommand extends AbstractContaoCommand
{
    ...
    {
        return $this->getApplication()->isContaoEnterprise();
    }
