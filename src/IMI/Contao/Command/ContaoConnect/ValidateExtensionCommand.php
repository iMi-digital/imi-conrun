...
class ValidateExtensionCommand extends AbstractContaoCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addOption('include-default', null, InputOption::VALUE_NONE, 'Include default packages that ship with Contao Connect')
            ->setDescription('Reads Contao Connect Config, and checks that installed package files are really there');

        $help = <<<HELP
Reads Contao Connect config, and checks that installed
package files are really there.

Contao Connect is Contao's built in package manager.  It's
...
Contao Connect, and uses the package manifest to check
