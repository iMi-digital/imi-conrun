...
EOT
            ...
            ->addOption('conrun-script', null, InputOption::VALUE_NONE, 'Output for usage with config:set')
            ->addOption(
                'format',
                null,
...
HELP;
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($this->initContao()) {
            ...
            } elseif ($input->getOption('conrun-script')) {
                $this->renderAsContrunScript($output, $table);
            } else {
    ...
    protected function renderAsUpdateScript(OutputInterface $output, $table)
    {
        ...
        $output->writeln('# generated by imi-conrun');
     ...
     * @param array           $table
     */
    protected function renderAsContrunScript(OutputInterface $output, $table)
    {
        foreach ($table as $row) {
