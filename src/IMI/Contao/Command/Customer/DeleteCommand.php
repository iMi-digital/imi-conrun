...
/**
 * Class DeleteCommand
 * @package IMI\Contao\Command\Customer
 */
...
imi-conrun customer:delete 1                   <info># Will delete customer with Id 1</info>
imi-conrun customer:delete mike@example.com    <info># Will delete customer with that email</info>
imi-conrun customer:delete --all               <info># Will delete all customers</info>
imi-conrun customer:delete --range             <info># Will prompt for start and end Ids for batch deletion</info>
